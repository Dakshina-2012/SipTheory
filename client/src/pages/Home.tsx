    ...
    <div className="site-shell">
      ...
      <main>
        <section id="home" className="hero-section">
          <img className="hero-image" src={images.hero} alt="Latte on a sunlit table in the SipTheory cafe" />
